package com.navbuilder.app.hurricane.ui.view;
...
public class ScaleImageView extends ImageView {
    ...
    private InternalChangeListener imageChangeListener;
    private boolean scaleToWidth = false; // this flag determines if should
                                          // measure height manually dependent
                                          // of width

    private ImageChangedListener mImageChangedListener;
    ...
    private void init() {
        ...
        imageChangeListener = new InternalChangeListener() {

			@Override
			public void changed(boolean isEmpty) {
				if(!isEmpty) {
					imageWidth = ScaleImageView.this.getDrawable().getIntrinsicWidth();
					imageHeight = ScaleImageView.this.getDrawable().getIntrinsicHeight();
					if(mImageChangedListener != null) {
						mImageChangedListener.changed();
					}
				}
			}
    ...
    public void setImageResource(int id) {
        ...
        if (imageChangeListener != null)
            imageChangeListener.changed((id == -1));
    }

    private interface InternalChangeListener {
    ...
    public ImageChangedListener getImageChangedListener() {
        return mImageChangedListener;
    }

    public void setImageChangedListener(ImageChangedListener mImageChangedListener) {
        this.mImageChangedListener = mImageChangedListener;
    }
