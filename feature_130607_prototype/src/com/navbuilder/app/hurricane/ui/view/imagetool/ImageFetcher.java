...
package com.navbuilder.app.hurricane.ui.view.imagetool;
...
import com.navbuilder.app.hurricane.BuildConfig;
...
public class ImageFetcher extends ImageResizer {
    ...
    /**
	 * Load an image specified by the data parameter (override
	...
	public void loadImage(Object data) {
		...
		if (getImageCache() != null) {
			bitmap = getImageCache().getBitmapFromMemCache(String.valueOf(data));
		}
	...
	private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
		...
		protected Bitmap doInBackground(Object... params) {
			...
			if (getImageCache() != null && !isCancelled()) {
				bitmap = getImageCache().getBitmapFromDiskCache(dataString);
			}
			...
			if (bitmap != null && getImageCache() != null) {
				getImageCache().addBitmapToCache(dataString, bitmap);
			}
