...
public class CustomDialog extends AlertDialog {
    ...
    public void show() {
        if (mDlgImlp.show(this)) {
            ...
            AfterUIlog.d(this, "[CustomDialog][show]dismissable:"
                    + autoDismissable);
            if (autoDismissable) {
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        AfterUIlog.d(this,
                                "[CustomDialog][show]auto dismiss dialog");
                        setOnDismissListener(new OnDismissListener() {
                            ...
                            public void onDismiss(DialogInterface dialog) {
                                ...
                                if (autoDismissRunnable != null) {
                                    ...
                                    int delay = Utilities
                                            .isDisableAnimationSetting(uiContext) ? 0
                                            : fadeOutTimes;
                                    new Handler().postDelayed(new Runnable() {
                                        @Override
                                        public void run() {
    ...
    public void configureAutoDismissableDialog(boolean dismissable, Runnable r) {
        AfterUIlog.d(this,
                "[CustomDialog][configureAutoDismissableDialog]dismissable:"
                        + dismissable);
    ...
    public void setTitle(CharSequence title) {
        /*
         * if (title != null) { String toSave = title.toString();
         * super.setTitle(toSave); mAlert.setTitle(toSave); }
         */
    ...
    public void setView(View view, int viewSpacingLeft, int viewSpacingTop,
        ...
        // mAlert.setView(view, viewSpacingLeft, viewSpacingTop,
        // viewSpacingRight, viewSpacingBottom);
        if (mDlgImlp.setView(view, viewSpacingLeft, viewSpacingTop,
                viewSpacingRight, viewSpacingRight)) {
    ...
    // For fixing bug 129026: Language: Downloading progress disappear then
    // display automatically when press search hard key
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (isKeyCodeSearchHandled(event))
            return true;
     ...
     * if(isKeyCodeSearchHandled(event)) return true; if
     * (mAlert.onKeyDown(keyCode, event)) return true; return
     * super.onKeyDown(keyCode, event); }
     * 
     * @Override public boolean onKeyUp(int keyCode, KeyEvent event) {
     * if(isKeyCodeSearchHandled(event)) return true; if
     * (mAlert.onKeyUp(keyCode, event)) return true; return
