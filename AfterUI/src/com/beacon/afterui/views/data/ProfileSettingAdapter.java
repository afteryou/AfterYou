...
public class ProfileSettingAdapter extends BaseAdapter {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (modal.label.equals(PASSWORD)) {
			// holder.sub_txt.setTransformationMethod(PasswordTransformationMethod
			// .getInstance());
			holder.sub_txt.setInputType(InputType.TYPE_CLASS_TEXT
