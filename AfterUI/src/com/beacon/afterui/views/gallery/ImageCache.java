...
import com.beacon.afterui.imageUtils.ImageWorker;
...
public class ImageCache {
	...
	public static ImageCache getInstance(FragmentManager fragmentManager,
		...
		if (imageCache == null) {
			...
			Log.d("ImageCashe", "getinstance called and imagecash was null");
		}
	...
	private void init(ImageCacheParams cacheParams) {
		...
		Log.d("ImageCashe", "memory -----------cashe is created");
	}
