...
import com.beacon.afterui.views.data.SingleSearchController.SingleSearchResult;
...
public class CacheManager {
    ...
    public synchronized void clearAllCache() {
        ...
        AfterUIlog.i(this, "All caches has been clear.");
    }
    ...
    private synchronized int createNewCache(byte type, SingleSearchResult result) {
        ...
        AfterUIlog.i(this, "Create new cache for type " + type + " with new key " + key + " ,length "
    ...
    private synchronized int appendToCache(byte type, SingleSearchResult result) {
        ...
        if (cache == null) {
            ...
            append(cache, result);
            AfterUIlog.i(this, "Result append to cache of type " + type + " key " + key
    ...
    private void removePrevResult(byte type) {
        try {
            ...
            if (cacheKey_cacheData_mapping.get(key) == null) {
            	AfterUIlog.i(this, "No prev result to remove for type " + type);
            } else {
                ...
                AfterUIlog.i(this, "Prev result has removed for type " + type);
            }
        } catch (Exception e) {
