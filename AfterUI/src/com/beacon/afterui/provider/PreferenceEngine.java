...
public class PreferenceEngine {
	...
	public String getSelfHeightFoot() {
		return getDefaultSharePreference().getString(AppConstants.SELF_HEIGHT_FOOT,
				null);
	}
	public String getMatchHeightFoot() {
		return getDefaultSharePreference().getString(AppConstants.MATCH_HEIGHT_FOOT,
				null);
	}
	public String getSelfHeightInches() {
		return getDefaultSharePreference().getString(AppConstants.SELF_HEIGHT_INCHES,
				null);
	}
	public String getMatchHeightInches() {
		return getDefaultSharePreference().getString(AppConstants.MATCH_HEIGHT_INCHES,
				null);
	}
