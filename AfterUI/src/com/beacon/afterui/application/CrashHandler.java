...
public class CrashHandler implements UncaughtExceptionHandler {
	...
	public void collectCrashDeviceInfo(Context ctx) {
		try {
			...
			AfterUIlog.e(TAG, "Error while collect package info", e);
		}
		...
		for (Field field : fields) {
			try {
				...
				AfterUIlog.e(TAG, "Error while collect crash info", e);
			}
		}
	}
	...
	private String saveCrashInfoToFile(Throwable ex) {
		...
		try {
			...
			AfterUIlog.e(TAG, "an error occured while writing report file...", e);
		} finally {
