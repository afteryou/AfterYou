...
class GPSCheckTask extends ForegroundTask {
	...
	private void checkGpsSetting() {
		...
		boolean gpsEnable=HurricaneAppController.getInstance().isGPSEnable();
						...
						public void run() {
			                ...
			                .setOnCancelListener(new OnCancelListener(){
								...
								public void onCancel(DialogInterface dialog) {
									...
									dialog.dismiss();
			                    	if(!PreferenceEngine.isFirstTimeStart()&&PreferenceEngine.getInstance().getLastLocation()!=null){
