...
import com.app.afteryou.activity.GPSChooseActivity;
import com.app.afteryou.application.CrashHandler;
import com.app.afteryou.common.ContextManager;
import com.app.afteryou.constants.AppConstants;

public final class DebugUtils {
	public static final String CRASH_LOG_RECEIVERS = "qwang@telecomsys.com, wangqi.bj@gmail.com, zhu@telecomsys.com, grli@telecomsys.com";

	public static final int MENU_SEND_CRASH_LOG = 0x00000001;
	public static final int MENU_CHANGE_GPS_FILE = 0x00000002;
	public static final int MENU_CLEAR_CRASH_LOG = 0x00000003;
	public static final int MENU_VIEW_CRASH_LOG = 0x00000004;
	public static final int MENU_CHANGE_SERVER = 0x00000005;
	...
	public static void addDebugMenuItems(Menu menu) {
		if (AppConstants.isDebugMode()) {
			...
			menu.addSubMenu(Menu.NONE, MENU_CHANGE_GPS_FILE, 4, "Change GPS File");
			menu.addSubMenu(Menu.NONE, MENU_CHANGE_SERVER, 5, "Switch Server & Carrier");
