...
import com.app.afteryou.search.SingleSearchListenerImpl;
import com.app.afteryou.search.SuggestionSearchListenerImpl;
import com.app.afteryou.utils.AppUtils;
import com.app.afteryou.utils.ImageUtils;
import com.app.afteryou.utils.LocationUtils;
...
public class SingleSearchController {
	...
	private static class MySingleSearchListener extends SingleSearchListenerImpl {
		...
		public void onRequestError(NBIException exception, NBIRequest request) {
			...
			Toast.makeText(AfterYouApplication.getInstance(), exception.getErrorCode() + ": " + exception.getMessage(), Toast.LENGTH_LONG).show();
		}
	}
